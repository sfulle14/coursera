...
test_CSV_join_efficiency("coursera_classes/Python data visualization/cancer_risk_trimmed_solution.csv", "coursera_classes/Python data visualization/USA_Counties_with_FIPS_and_centers.csv")



# Code that test the efficiency of "in" operator on larger examples

TEST_SIZE = 20000        # 20000000
TEST_STRIDE = 3
