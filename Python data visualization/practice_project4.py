...
draw_cancer_risk_map("coursera_classes/Python data visualization/cancer_risk_joined_solution.csv", "coursera_classes/Python data visualization/USA_Counties_555x352.png", 200)
