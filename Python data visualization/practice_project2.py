...
process_county_attributes("coursera_classes/Python data visualization/USA_Counties_2014.svg", "coursera_classes/Python data visualization/USA_Counties_with_FIPS_and_centers.csv") 