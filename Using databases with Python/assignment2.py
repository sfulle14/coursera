...
conn = sqlite3.connect('coursera_classes/Using databases with Python/tracks/musicaltrackdb.sqlite')    # Makes database connection 
cur = conn.cursor()
...
if ( len(fname) < 1 ) : fname = 'coursera_classes/Using databases with Python/tracks/Library.xml'
