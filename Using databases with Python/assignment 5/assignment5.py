...
don't reveal where you live. Then run the geoload.py to lookup all of the entries in where.data 
(including the new one) and produce the geodata.sqlite. 
...
Please keep your comments positive and useful. If you do not take grading seriously, 
