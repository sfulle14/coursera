...
def test_part2_code():
    ...
    test_table = read_csv_file("coursera_classes/python data analysis/test_case.csv")  # file is available at ...
    ...
    cancer_risk_table = read_csv_file("coursera_classes/python data analysis/cancer_risk05_v4_county.csv")
    ...
    trimmed_risk_solution = read_csv_file("coursera_classes/python data analysis/cancer_risk_trimmed_solution.csv")
