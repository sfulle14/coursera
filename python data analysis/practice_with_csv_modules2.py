...
def csv_delimiter_examples():
    ...
    """
    number_table = read_csv_file("coursera_classes/python data analysis/number_table.csv", " ")
    print_table(number_table)
    print()
    name_table = read_csv_file("coursera_classes/python data analysis/name_table.csv", ",")
